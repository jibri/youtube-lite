...
declare namespace gapi.client {
    ...
    namespace youtube {
        ...
        interface CaptionsResource {
            ...
            body: Caption): HttpRequest<Caption>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface ChannelBannersResource {
            ...
            body: ChannelBannerResource): HttpRequest<ChannelBannerResource>;
        }
        interface ChannelsResource {
            ...
            body: Channel): HttpRequest<Channel>;
        }
        interface ChannelSectionsResource {
            ...
            body: ChannelSection): HttpRequest<ChannelSection>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface CommentsResource {
            ...
            body: Comment): HttpRequest<Comment>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface CommentThreadsResource {
            ...
            body: CommentThread): HttpRequest<CommentThread>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface LiveBroadcastsResource {
            ...
            body: LiveBroadcast): HttpRequest<LiveBroadcast>;
        ...
        interface LiveChatBansResource {
            ...
            body: LiveChatBan): HttpRequest<LiveChatBan>;
        }
        interface LiveChatMessagesResource {
            ...
            body: LiveChatMessage): HttpRequest<LiveChatMessage>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface LiveChatModeratorsResource {
            ...
            body: LiveChatModerator): HttpRequest<LiveChatModerator>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface LiveStreamsResource {
            ...
            body: LiveStream): HttpRequest<LiveStream>;
        ...
        interface PlaylistItemsResource {
            ...
            body: PlaylistItem): HttpRequest<PlaylistItem>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface PlaylistsResource {
            ...
            body: Playlist): HttpRequest<Playlist>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface SubscriptionsResource {
            ...
            body: Subscription): HttpRequest<Subscription>;
            /** Retrieves a list of resources, possibly filtered. */
            list(request?: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface VideosResource {
            ...
            body: VideoAbuseReport): HttpRequest<void>;
            /** Updates an existing resource. */
            update(request: {
                /** V1 error format. */
                "$.xgafv"?: string;
        ...
        interface WatermarksResource {
            ...
            body: InvideoBranding): HttpRequest<void>;
